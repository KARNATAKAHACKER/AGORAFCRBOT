...
async def start(event):
    ...
    if event.is_private:
       ...
       await event.reply(
             ...
             buttons=[
        [Button.url("Add me to your group ➕", url="t.me/taxfxr_bot?startgroup=true")],
        [Button.url("Channel 📢", url="t.me/ABOUTAGORA"), Button.url("Support 🌎", url="t.me/DO_JISM_EK_JAAN_OP")],
    ...
    if event.is_group:
        ...
        await event.client.send_file(event.chat_id,
             ...
             buttons=[
         [Button.url("Add me to your group ➕", url="t.me/TAXFCR_BOT?startgroup=true")]])
...
async def help(event):
    if event.is_group:
        buttons = [
            [Button.url("❔ Help", "https://t.me/TAXFCR_BOT?start=_help")],
        ]
        await event.reply(
