...
Promote me as administrator in your group otherwise I will not function properly""",
            buttons=[
                [Button.url("Support Chat", "https://t.me/do_jism_ek_jaan_op")],
                [Button.url("Updates Channel", "https://t.me/aboutagora")],
            ],
        )
    ...
    if sql.get_mode(chat_id) == True:
        ...
        if style in ["math", "text"]:
            custom_welcome = (
                custom_welcome
                + f"[{es}](btnurl://t.me/taxfcr_bot?start=captcha_{chat_id})"
            )
    if custom_welcome:
